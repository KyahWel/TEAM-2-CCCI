<template>
  ...
  <div class="form-container">
    ...
    <a-form-item >
      ...
      <a class="member-btn" type="link" @click="router.push('/')">Already a member? Login</a>
...
const disabled = computed(() => {
 ...
 // Register Function for Applicants
const handleSubmit = async (e) => {
  e.preventDefault();
  const { firstName, lastName, contactNo, username, email, password } = form;

  try {
    // POST request to the backend server to register a new user
